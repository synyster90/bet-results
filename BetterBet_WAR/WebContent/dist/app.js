...
var scommesse_service_1 = __webpack_require__(203);
var viewModal_1 = __webpack_require__(444);
var editModal_1 = __webpack_require__(442);
var insertModal_1 = __webpack_require__(443);
var Home = (function () {
    function Home(utilService, modalDialogService, scommesseService, httpClient, translateService, changeDetectorRef) {
        var _this = this;
        this.utilService = utilService;
...
var InsertModalCtrl = (function () {
    function InsertModalCtrl(utilService, scommesseService, modalDialogService, httpClient) {
        this.utilService = utilService;
        this.scommesseService = scommesseService;
        this.modalDialogService = modalDialogService;
        this.httpClient = httpClient;
...
var platform_browser_2 = __webpack_require__(35);
...
var utils_1 = __webpack_require__(40);
var app_component_1 = __webpack_require__(773);
var app_routes_1 = __webpack_require__(774);
var shared_module_1 = __webpack_require__(776);
...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.httpClient.get('rest/users').subscribe(function (data) {
            console.log(data);
            _this.changeDetectorRef.markForCheck();
        }, function (err) {
            console.log(err);
...
var translate_1 = __webpack_require__(107);
var utils_1 = __webpack_require__(40);
var filterModal_1 = __webpack_require__(775);
var scommesse_service_1 = __webpack_require__(203);
